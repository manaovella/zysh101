create_project xxyyzz Z:/Documents/workspace/test/xxyyzz -part xc7z010clg225-1
create_bd_design "design_1"
update_compile_order -fileset sources_1

startgroup
create_bd_cell -type ip -vlnv xilinx.com:ip:processing_system7:5.5 processing_system7_0
set_property -dict [list     CONFIG.PCW_DDR_RAM_HIGHADDR {0x1FFFFFFF}  \
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/processing_system7_0/M_AXI_GP0" \
intc_ip "/axi_smc" Clk_xbar "Auto" Clk_master "Auto" Clk_slave "Auto" }  [get_bd_intf_pins axi_bram_ctrl_1/S_AXI]
endgroup
# BRAM 2
startgroup
...
CONFIG.Port_B_Clock {100} \
CONFIG.Port_B_Write_Rate {50} \
CONFIG.Port_B_Enable_Rate {100}] [get_bd_cells axi_bram_ctrl_3_bram]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/processing_system7_0/M_AXI_GP0" \
intc_ip "/axi_smc" Clk_xbar "Auto" Clk_master "Auto" Clk_slave "Auto" }  [get_bd_intf_pins axi_bram_ctrl_3/S_AXI]
endgroup
# BRAM 4
startgroup
create_bd_cell -type ip -vlnv xilinx.com:ip:axi_bram_ctrl:4.0 axi_bram_ctrl_4
set_property -dict [list CONFIG.SINGLE_PORT_BRAM {1}] [get_bd_cells axi_bram_ctrl_4]
...
CONFIG.Port_B_Clock {100} \
CONFIG.Port_B_Write_Rate {50} \
CONFIG.Port_B_Enable_Rate {100}] [get_bd_cells axi_bram_ctrl_4_bram]
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/processing_system7_0/M_AXI_GP0" \
intc_ip "/axi_smc" Clk_xbar "Auto" Clk_master "Auto" Clk_slave "Auto" }  [get_bd_intf_pins axi_bram_ctrl_4/S_AXI]
endgroup
#
...
set_property range 4K [get_bd_addr_segs {processing_system7_0/Data/SEG_axi_bram_ctrl_4_Mem0}]
...
set_property -dict [list CONFIG.PROTOCOL {AXI4LITE} CONFIG.SINGLE_PORT_BRAM {1} CONFIG.ECC_TYPE {0}] [get_bd_cells axi_bram_ctrl_3]
set_property -dict [list CONFIG.PROTOCOL {AXI4LITE} CONFIG.SINGLE_PORT_BRAM {1} CONFIG.ECC_TYPE {0}] [get_bd_cells axi_bram_ctrl_4]
...
set_property -dict [list CONFIG.Assume_Synchronous_Clk {true}] [get_bd_cells axi_bram_ctrl_3_bram]
set_property -dict [list CONFIG.Assume_Synchronous_Clk {true}] [get_bd_cells axi_bram_ctrl_4_bram]

#
set_property  ip_repo_paths  {z:/Documents/workspace/zysh101/hls/devnullphase/zybe/impl/ip \
z:/Documents/workspace/zysh101/hls/devnulldata/solution1/impl/ip \
z:/Documents/workspace/zysh101/hls/devnulltest/solution1/impl/ip \
Z:/Documents/workspace/zysh101/hls/bramtest/solution1/impl/ip \
z:/Documents/workspace/zysh101/hls/phasegen/zybe/impl/ip \
z:/Documents/workspace/zysh101/hls/nco/zybe/impl/ip \
z:/Documents/workspace/zysh101/hls/vca/zybe/impl/ip \
z:/Documents/workspace/zysh101/hls/devnulli2s/zybe/impl/ip} [current_project]
update_ip_catalog
...
make_wrapper -files [get_files Z:/Documents/workspace/test/xxyyzz/xxyyzz.srcs/sources_1/bd/design_1/design_1.bd] -top
add_files -norecurse Z:/Documents/workspace/test/xxyyzz/xxyyzz.srcs/sources_1/bd/design_1/hdl/design_1_wrapper.v