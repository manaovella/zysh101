...
HD_PWD='Z:/Documents/workspace/zysh101/src/tcl/nco/zybe/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nco.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nco.tcl -notrace
