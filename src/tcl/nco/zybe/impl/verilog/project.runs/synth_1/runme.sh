...
HD_PWD='Z:/Documents/workspace/zysh101/src/tcl/nco/zybe/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nco.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nco.tcl
