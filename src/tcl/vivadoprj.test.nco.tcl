create_project testnco Z:/Documents/workspace/testnco -part xc7z010clg225-1
create_bd_design "test_nco_1"
...
apply_bd_automation -rule xilinx.com:bd_rule:axi4 -config {Master "/processing_system7_0/M_AXI_GP0" \
intc_ip "Auto" Clk_xbar "Auto" Clk_master "Auto" Clk_slave "Auto" }  [get_bd_intf_pins axi_bram_ctrl_2/S_AXI]
...
# apply_bd_automation -rule xilinx.com:bd_rule:bram_cntlr -config {BRAM "/axi_bram_ctrl_2_bram" }  [get_bd_intf_pins phasedevnull_0/params_V_PORTA]
