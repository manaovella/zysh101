...
HD_PWD='Z:/Documents/workspace/zysh101/src/tcl/testnco/nco/nco.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nco_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nco_1_wrapper.tcl -notrace
