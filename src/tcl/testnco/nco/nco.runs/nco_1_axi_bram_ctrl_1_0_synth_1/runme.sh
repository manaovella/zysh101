...
HD_PWD='Z:/Documents/workspace/zysh101/src/tcl/testnco/nco/nco.runs/nco_1_axi_bram_ctrl_1_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nco_1_axi_bram_ctrl_1_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nco_1_axi_bram_ctrl_1_0.tcl
