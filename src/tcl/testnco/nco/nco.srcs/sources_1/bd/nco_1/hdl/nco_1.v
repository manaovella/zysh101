...
//Date        : Mon Nov 27 23:50:15 2017
//Host        : MANOVELLA4169 running 64-bit major release  (build 9200)
//Command     : generate_target nco_1.bd
//Design      : nco_1
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "nco_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=nco_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=13,numReposBlks=13,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=3,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=4,da_bram_cntlr_cnt=6,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "nco_1.hwdef" *) 
module nco_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  wire [31:0]datadevnull_0_params_V_PORTA_ADDR;
  wire datadevnull_0_params_V_PORTA_CLK;
  wire [31:0]datadevnull_0_params_V_PORTA_DIN;
  wire [31:0]datadevnull_0_params_V_PORTA_DOUT;
  wire datadevnull_0_params_V_PORTA_EN;
  wire datadevnull_0_params_V_PORTA_RST;
  wire [3:0]datadevnull_0_params_V_PORTA_WE;
  ...
  wire [31:0]nco_0_dataout_V_TDATA;
  wire nco_0_dataout_V_TREADY;
  wire nco_0_dataout_V_TVALID;
  wire [31:0]nco_0_params_V_PORTA_ADDR;
  wire nco_0_params_V_PORTA_CLK;
  wire [31:0]nco_0_params_V_PORTA_DIN;
  wire [31:0]nco_0_params_V_PORTA_DOUT;
  wire nco_0_params_V_PORTA_EN;
  wire nco_0_params_V_PORTA_RST;
  wire [3:0]nco_0_params_V_PORTA_WE;
  wire [31:0]phasegen_0_outval_V_TDATA;
  wire phasegen_0_outval_V_TREADY;
  wire phasegen_0_outval_V_TVALID;
  wire [31:0]phasegen_0_params_V_PORTA_ADDR;
  wire phasegen_0_params_V_PORTA_CLK;
  wire [31:0]phasegen_0_params_V_PORTA_DIN;
  wire [31:0]phasegen_0_params_V_PORTA_DOUT;
  wire phasegen_0_params_V_PORTA_EN;
  wire phasegen_0_params_V_PORTA_RST;
  wire [3:0]phasegen_0_params_V_PORTA_WE;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > nco_1 axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  nco_1_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  nco_1_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(phasegen_0_params_V_PORTA_ADDR),
        .clka(axi_bram_ctrl_0_BRAM_PORTA_CLK),
        .clkb(phasegen_0_params_V_PORTA_CLK),
        .dina(axi_bram_ctrl_0_BRAM_PORTA_DIN),
        .dinb(phasegen_0_params_V_PORTA_DIN),
        .douta(axi_bram_ctrl_0_BRAM_PORTA_DOUT),
        .doutb(phasegen_0_params_V_PORTA_DOUT),
        .ena(axi_bram_ctrl_0_BRAM_PORTA_EN),
        .enb(phasegen_0_params_V_PORTA_EN),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(phasegen_0_params_V_PORTA_RST),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(phasegen_0_params_V_PORTA_WE));
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x42000000 32 > nco_1 axi_bram_ctrl_1_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  nco_1_axi_bram_ctrl_1_0 axi_bram_ctrl_1
  ...
  nco_1_axi_bram_ctrl_1_bram_0 axi_bram_ctrl_1_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_1_BRAM_PORTA_ADDR}),
        .addrb(nco_0_params_V_PORTA_ADDR),
        .clka(axi_bram_ctrl_1_BRAM_PORTA_CLK),
        .clkb(nco_0_params_V_PORTA_CLK),
        .dina(axi_bram_ctrl_1_BRAM_PORTA_DIN),
        .dinb(nco_0_params_V_PORTA_DIN),
        .douta(axi_bram_ctrl_1_BRAM_PORTA_DOUT),
        .doutb(nco_0_params_V_PORTA_DOUT),
        .ena(axi_bram_ctrl_1_BRAM_PORTA_EN),
        .enb(nco_0_params_V_PORTA_EN),
        .rsta(axi_bram_ctrl_1_BRAM_PORTA_RST),
        .rstb(nco_0_params_V_PORTA_RST),
        .wea(axi_bram_ctrl_1_BRAM_PORTA_WE),
        .web(nco_0_params_V_PORTA_WE));
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x44000000 32 > nco_1 axi_bram_ctrl_2_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  nco_1_axi_bram_ctrl_2_0 axi_bram_ctrl_2
  ...
  nco_1_axi_bram_ctrl_2_bram_0 axi_bram_ctrl_2_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_2_BRAM_PORTA_ADDR}),
        .addrb(datadevnull_0_params_V_PORTA_ADDR),
        .clka(axi_bram_ctrl_2_BRAM_PORTA_CLK),
        .clkb(datadevnull_0_params_V_PORTA_CLK),
        .dina(axi_bram_ctrl_2_BRAM_PORTA_DIN),
        .dinb(datadevnull_0_params_V_PORTA_DIN),
        .douta(axi_bram_ctrl_2_BRAM_PORTA_DOUT),
        .doutb(datadevnull_0_params_V_PORTA_DOUT),
        .ena(axi_bram_ctrl_2_BRAM_PORTA_EN),
        .enb(datadevnull_0_params_V_PORTA_EN),
        .rsta(axi_bram_ctrl_2_BRAM_PORTA_RST),
        .rstb(datadevnull_0_params_V_PORTA_RST),
        .wea(axi_bram_ctrl_2_BRAM_PORTA_WE),
        .web(datadevnull_0_params_V_PORTA_WE));
  nco_1_axi_smc_0 axi_smc
  ...
  nco_1_datadevnull_0_0 datadevnull_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst_n(rst_ps7_0_100M_peripheral_aresetn),
        .inv_V_TDATA(nco_0_dataout_V_TDATA),
        .inv_V_TREADY(nco_0_dataout_V_TREADY),
        .inv_V_TVALID(nco_0_dataout_V_TVALID),
        .params_V_Addr_A(datadevnull_0_params_V_PORTA_ADDR),
        .params_V_Clk_A(datadevnull_0_params_V_PORTA_CLK),
        .params_V_Din_A(datadevnull_0_params_V_PORTA_DIN),
        .params_V_Dout_A(datadevnull_0_params_V_PORTA_DOUT),
        .params_V_EN_A(datadevnull_0_params_V_PORTA_EN),
        .params_V_Rst_A(datadevnull_0_params_V_PORTA_RST),
        .params_V_WEN_A(datadevnull_0_params_V_PORTA_WE));
  nco_1_jtag_axi_0_0 jtag_axi_0
       (.aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(rst_ps7_0_100M_peripheral_aresetn),
  ...
  nco_1_nco_0_0 nco_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst_n(rst_ps7_0_100M_peripheral_aresetn),
        .dataout_V_TDATA(nco_0_dataout_V_TDATA),
        .dataout_V_TREADY(nco_0_dataout_V_TREADY),
        .dataout_V_TVALID(nco_0_dataout_V_TVALID),
        .params_V_Addr_A(nco_0_params_V_PORTA_ADDR),
        .params_V_Clk_A(nco_0_params_V_PORTA_CLK),
        .params_V_Din_A(nco_0_params_V_PORTA_DIN),
        .params_V_Dout_A(nco_0_params_V_PORTA_DOUT),
        .params_V_EN_A(nco_0_params_V_PORTA_EN),
        .params_V_Rst_A(nco_0_params_V_PORTA_RST),
        .params_V_WEN_A(nco_0_params_V_PORTA_WE),
        .phasein_V_TDATA(phasegen_0_outval_V_TDATA),
        .phasein_V_TREADY(phasegen_0_outval_V_TREADY),
        .phasein_V_TVALID(phasegen_0_outval_V_TVALID));
  nco_1_phasegen_0_0 phasegen_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst_n(rst_ps7_0_100M_peripheral_aresetn),
        .outval_V_TDATA(phasegen_0_outval_V_TDATA),
        .outval_V_TREADY(phasegen_0_outval_V_TREADY),
        .outval_V_TVALID(phasegen_0_outval_V_TVALID),
        .params_V_Addr_A(phasegen_0_params_V_PORTA_ADDR),
        .params_V_Clk_A(phasegen_0_params_V_PORTA_CLK),
        .params_V_Din_A(phasegen_0_params_V_PORTA_DIN),
        .params_V_Dout_A(phasegen_0_params_V_PORTA_DOUT),
        .params_V_EN_A(phasegen_0_params_V_PORTA_EN),
        .params_V_Rst_A(phasegen_0_params_V_PORTA_RST),
        .params_V_WEN_A(phasegen_0_params_V_PORTA_WE));
  (* BMM_INFO_PROCESSOR = "arm > nco_1 axi_bram_ctrl_0 nco_1 axi_bram_ctrl_1 nco_1 axi_bram_ctrl_2" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  nco_1_processing_system7_0_0 processing_system7_0
  ...
  nco_1_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
