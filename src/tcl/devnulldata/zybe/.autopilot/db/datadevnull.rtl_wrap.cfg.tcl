...
set DataType00 "[list ap_fixed 24 2 5 3 0 ]"
...
set DataType0 [list "data_t" "struct data_t" $structMem0 1 0 $structParameter0 $structArgument0 $NameSpace0 $structIsPacked0]
