...
HD_PWD='Z:/Documents/workspace/zysh101/src/tcl/devnulldata/zybe/impl/verilog/project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log datadevnull.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source datadevnull.tcl -notrace
