...
HD_PWD='Z:/Documents/workspace/zysh101/src/tcl/devnulldata/zybe/impl/verilog/project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log datadevnull.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source datadevnull.tcl
