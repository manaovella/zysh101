...
HD_PWD='Z:/Documents/workspace/zysh101/src/tcl/testphasegen/test_phasegen/test_phasegen.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log test_phasegen_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source test_phasegen_1_wrapper.tcl -notrace
