...
HD_PWD='Z:/Documents/workspace/zysh101/src/tcl/testphasegen/test_phasegen/test_phasegen.runs/test_phasegen_1_axi_smc_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log test_phasegen_1_axi_smc_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source test_phasegen_1_axi_smc_0.tcl
