...
//Command     : generate_target test_phasegen_1.bd
//Design      : test_phasegen_1
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "test_phasegen_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=test_phasegen_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=10,numReposBlks=10,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=2,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=3,da_bram_cntlr_cnt=4,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "test_phasegen_1.hwdef" *) 
module test_phasegen_1
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
    DDR_ck_n,
  ...
  wire [31:0]phasedevnull_0_params_V_PORTA_ADDR;
  wire phasedevnull_0_params_V_PORTA_CLK;
  wire [31:0]phasedevnull_0_params_V_PORTA_DIN;
  wire [31:0]phasedevnull_0_params_V_PORTA_DOUT;
  wire phasedevnull_0_params_V_PORTA_EN;
  wire phasedevnull_0_params_V_PORTA_RST;
  wire [3:0]phasedevnull_0_params_V_PORTA_WE;
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > test_phasegen_1 axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  test_phasegen_1_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  test_phasegen_1_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x42000000 32 > test_phasegen_1 axi_bram_ctrl_1_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  test_phasegen_1_axi_bram_ctrl_1_0 axi_bram_ctrl_1
  ...
  test_phasegen_1_axi_bram_ctrl_1_bram_0 axi_bram_ctrl_1_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_1_BRAM_PORTA_ADDR}),
        .addrb(phasedevnull_0_params_V_PORTA_ADDR),
        .clka(axi_bram_ctrl_1_BRAM_PORTA_CLK),
        .clkb(phasedevnull_0_params_V_PORTA_CLK),
        .dina(axi_bram_ctrl_1_BRAM_PORTA_DIN),
        .dinb(phasedevnull_0_params_V_PORTA_DIN),
        .douta(axi_bram_ctrl_1_BRAM_PORTA_DOUT),
        .doutb(phasedevnull_0_params_V_PORTA_DOUT),
        .ena(axi_bram_ctrl_1_BRAM_PORTA_EN),
        .enb(phasedevnull_0_params_V_PORTA_EN),
        .rsta(axi_bram_ctrl_1_BRAM_PORTA_RST),
        .rstb(phasedevnull_0_params_V_PORTA_RST),
        .wea(axi_bram_ctrl_1_BRAM_PORTA_WE),
        .web(phasedevnull_0_params_V_PORTA_WE));
  test_phasegen_1_axi_smc_0 axi_smc
  ...
  test_phasegen_1_jtag_axi_0_0 jtag_axi_0
       (.aclk(processing_system7_0_FCLK_CLK0),
        .aresetn(rst_ps7_0_100M_peripheral_aresetn),
  ...
  test_phasegen_1_phasedevnull_0_0 phasedevnull_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst_n(rst_ps7_0_100M_peripheral_aresetn),
        .inv_V_TDATA(phasegen_0_outval_V_TDATA),
        .inv_V_TREADY(phasegen_0_outval_V_TREADY),
        .inv_V_TVALID(phasegen_0_outval_V_TVALID),
        .params_V_Addr_A(phasedevnull_0_params_V_PORTA_ADDR),
        .params_V_Clk_A(phasedevnull_0_params_V_PORTA_CLK),
        .params_V_Din_A(phasedevnull_0_params_V_PORTA_DIN),
        .params_V_Dout_A(phasedevnull_0_params_V_PORTA_DOUT),
        .params_V_EN_A(phasedevnull_0_params_V_PORTA_EN),
        .params_V_Rst_A(phasedevnull_0_params_V_PORTA_RST),
        .params_V_WEN_A(phasedevnull_0_params_V_PORTA_WE));
  test_phasegen_1_phasegen_0_0 phasegen_0
       (.ap_clk(processing_system7_0_FCLK_CLK0),
        .ap_rst_n(rst_ps7_0_100M_peripheral_aresetn),
  ...
  (* BMM_INFO_PROCESSOR = "arm > test_phasegen_1 axi_bram_ctrl_0 test_phasegen_1 axi_bram_ctrl_1" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  test_phasegen_1_processing_system7_0_0 processing_system7_0
  ...
  test_phasegen_1_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
