...
################################################################
# This is a generated script based on design: test_phasegen_1
#
...
# source test_phasegen_1_script.tcl
...
set design_name test_phasegen_1
...
CONFIG.NUM_SI {2} \
  ...
  # Create instance: phasedevnull_0, and set properties
  set phasedevnull_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:phasedevnull:1.0 phasedevnull_0 ]

  # Create instance: phasegen_0, and set properties
  set phasegen_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:phasegen:1.0 phasegen_0 ]
...
CONFIG.PCW_USE_S_AXI_HP1 {0} \
  ...
  connect_bd_intf_net -intf_net phasedevnull_0_params_V_PORTA [get_bd_intf_pins axi_bram_ctrl_1_bram/BRAM_PORTB] [get_bd_intf_pins phasedevnull_0/params_V_PORTA]
  connect_bd_intf_net -intf_net phasegen_0_outval_V [get_bd_intf_pins phasedevnull_0/inv_V] [get_bd_intf_pins phasegen_0/outval_V]
  connect_bd_intf_net -intf_net phasegen_0_params_V_PORTA [get_bd_intf_pins axi_bram_ctrl_0_bram/BRAM_PORTB] [get_bd_intf_pins phasegen_0/params_V_PORTA]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins jtag_axi_0/aclk] [get_bd_pins phasedevnull_0/ap_clk] [get_bd_pins phasegen_0/ap_clk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins jtag_axi_0/aresetn] [get_bd_pins phasedevnull_0/ap_rst_n] [get_bd_pins phasegen_0/ap_rst_n] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]

  # Create address segments
  create_bd_addr_seg -range 0x00001000 -offset 0x40000000 [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] SEG_axi_bram_ctrl_0_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0x42000000 [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs axi_bram_ctrl_1/S_AXI/Mem0] SEG_axi_bram_ctrl_1_Mem0
