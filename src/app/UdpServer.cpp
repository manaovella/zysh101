...
void myprintf(char* string, int i);
void myprintf(char* string, int i, int j);
...
int UdpServer::empty(int maxCount)
{
	...
	myprintf("socket emptied with %d reads\n", count);
	return count;
}
