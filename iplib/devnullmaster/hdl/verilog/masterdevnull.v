...
(* CORE_GENERATION_INFO="masterdevnull,hls_ip_2017_2,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z010clg225-1,HLS_INPUT_CLOCK=4.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=3.264000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=206,HLS_SYN_LUT=143}" *)

module masterdevnull (
        ap_clk,
        ap_rst_n,
        inv_TDATA,
        inv_TVALID,
...
always @ (posedge ap_clk) begin
    if (ap_rst_n_inv == 1'b1) begin
        ...
        if ((((1'b0 == inv_0_vld_in) & (1'b1 == inv_0_ack_out) & (inv_0_state == 2'd3)) | ((1'b0 == inv_0_vld_in) & (inv_0_state == 2'd2)))) begin
            inv_0_state <= 2'd2;
        end else if ((((1'b1 == inv_0_vld_in) & (1'b0 == inv_0_ack_out) & (inv_0_state == 2'd3)) | ((1'b0 == inv_0_ack_out) & (inv_0_state == 2'd1)))) begin
            inv_0_state <= 2'd1;
        end else if ((((1'b1 == inv_0_vld_in) & (inv_0_state == 2'd2)) | ((1'b1 == inv_0_ack_out) & (inv_0_state == 2'd1)) | ((inv_0_state == 2'd3) & ~((1'b1 == inv_0_vld_in) & (1'b0 == inv_0_ack_out)) & ~((1'b0 == inv_0_vld_in) & (1'b1 == inv_0_ack_out))))) begin
            inv_0_state <= 2'd3;
        end else begin
            inv_0_state <= 2'd2;
        end
...
assign inv_0_ack_out = 1'b0;

assign inv_0_vld_in = inv_TVALID;

assign inv_TREADY = inv_0_state[1'd1];
